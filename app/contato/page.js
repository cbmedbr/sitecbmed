    ...
    <>
      ...
      <section className="bg-[#F0EDE6] py-16">
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-white rounded-3xl shadow-xl border border-black/5 px-10 py-8 flex flex-col sm:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="font-serif text-xl font-semibold text-ink">Fale pelo WhatsApp</p>
                <p className="text-ink-light text-sm mt-0.5">Atendimento ágil e humanizado.</p>
              </div>
            </div>
            <a href={WHATSAPP} target="_blank" rel="noopener noreferrer"
              className="shrink-0 inline-flex items-center gap-2.5 bg-forest text-white font-bold px-7 py-3.5 rounded-xl hover:bg-brand-600 transition-all shadow-md whitespace-nowrap">
