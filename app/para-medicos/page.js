      ...
      <section className="bg-gradient-to-br from-gray-950 via-brand-900 to-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="badge mb-5 bg-white/10 text-brand-200 border border-white/10">Canal Exclusivo</span>
            <h1 className="text-4xl md:text-5xl font-extrabold mb-5 leading-tight">
              Área do Médico <span className="text-brand-400">Prescritor</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/ciencia" className="inline-flex items-center gap-2 border-2 border-white/20 text-gray-200 hover:bg-white/10 font-semibold px-8 py-4 rounded-xl transition-colors text-base">
                Material Científico
              </Link>
            </div>
